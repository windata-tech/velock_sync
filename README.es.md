...
- Sincronización de carpetas genéricas: los usuarios que no usan Velock pueden elegir una carpeta local, cifrada de extremo a extremo por defecto, con modo espejo normal.
